...
export class ProgressComponent implements OnInit, AfterViewInit {
  ...
  generarInformeAsesorias() {
    const resumen = {
      ...
      evolucion: 'En cuanto al consumo energético del último año obtenemos un total de 150.904 kWh/año. Se estima una reducción de un 15% de este consumo energético, calculado en caso de llevar a cabo todas las medidas propuestas en los diversos comercios.',
